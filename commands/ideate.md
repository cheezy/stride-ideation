...
Skill(skill: "stride-ideation",
      args: "topic=<TOPIC>; slug=<SLUG>; session_ts=<SESSION_TS>; target_path=<TARGET_PATH>; prior_doc=<PRIOR_DOC>; input_notes=<INPUT_NOTES>; draft_path=<DRAFT_PATH>; profile=<PROFILE>")
```
...
- the mandatory round-4 premortem (see **Round-4 premortem** in `skills/stride-ideation/SKILL.md`),
