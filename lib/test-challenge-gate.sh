...
# skills/stride-ideation/SKILL.md (W1364) and wired into commands/ideate.md
# (W1365). The gate is an interactive AskUserQuestion step that cannot be
# driven from a non-interactive runner, so this test asserts the *output
# contract* — the shape a committed requirements doc must exhibit once the
# gate has run — against the committed fixture
